...
1. Nextcloud: Nextcloud with php-fpm, mariadb, https (using Let's Encrypt) and full-text search activated and working.
2. Plex: Plex server installed alongside transmission and flexget connecting both.
